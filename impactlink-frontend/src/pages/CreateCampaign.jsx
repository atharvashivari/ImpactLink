...
const CreateCampaign = () => {
  ...
  return (
    <div className="page-container py-5 mt-3">
        ...
        <div className="mb-5 px-3 px-md-5">
          <div className="d-flex justify-content-between position-relative">
            <div className="progress position-absolute top-50 start-0 w-100 translate-middle-y z-0" style={{ height: "4px" }}>
              <div className="progress-bar bg-primary transition-all execution-time" role="progressbar" style={{ width: `${((step - 1) / 2) * 100}%` }}></div>
            </div>

            {[1, 2, 3].map((num) => (
              <div key={num} className={`position-relative z-1 rounded-circle d-flex align-items-center justify-content-center fw-bold ${step >= num ? 'bg-primary text-white' : 'bg-light text-muted border'}`} style={{ width: "40px", height: "40px", transition: "all 0.3s ease" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 1 && (
              <div className="animation-fade-in">
                ...
                <div className="mb-4">
                  <label className="label-custom">Campaign Title</label>
                  <input
                    type="text"
                    name="title"
                    className="input-custom form-control-lg"
                ...
                <div className="mb-4">
                  ...
                  <select
                    name="category"
                    className="input-custom form-select form-select-lg text-muted"
                ...
                <div className="mb-4">
                  <label className="label-custom">Funding Goal ($)</label>
            ...
            {step === 3 && (
              <div className="animation-fade-in">
                ...
                <div className="mb-4">
                  <label className="label-custom">Campaign Image URL</label>
                  <input
                    type="url"
                    name="imageUrl"
                    className="input-custom"
                    ...
                    required
                  />
                  <small className="text-muted mt-2 d-block">Provide a high-quality image URL that represents your campaign.</small>
                </div>

                {campaign.imageUrl ? (
                  <div className="mb-5 mt-4 p-2 border rounded bg-light">
                    <img
                  ...
                  <div className="mb-5 mt-4 border rounded bg-light d-flex flex-column align-items-center justify-content-center text-muted" style={{ height: "250px" }}>
                    <ImageIcon size={48} className="mb-2 opacity-50" />
                    <p>Image preview will appear here</p>
                  </div>
                )}

                <div className="alert bg-primary-subtle text-primary border-primary border-opacity-25 rounded p-3">
                  <div className="d-flex gap-2">
                    <Check size={20} className="mt-1 flex-shrink-0" />
                    <div>
                      <strong>Ready to launch!</strong> Please review your details before submitting. Once live, your campaign can start receiving donations.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className={`d-flex mt-5 ${step === 1 ? 'justify-content-end' : 'justify-content-between'}`}>
              {step > 1 && (
                <button type="button" className="btn btn-outline-custom d-flex align-items-center gap-2" onClick={prevStep}>
              ...
              >
                {step < 3 ? (
                  ...
                  <><div className="spinner-border spinner-border-sm" role="status"></div> Launching...</>
                ) : (
                  <>Launch Campaign</>
                )}
              </button>
